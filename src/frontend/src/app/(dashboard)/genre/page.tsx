...
export default function GenrePage() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      ...
      if (first.isIntersecting && !isLoadingGenreDiscover && genreDiscoverHasMore && selectedGenres.length > 0) {
        loadNextGenreDiscover();
      }
  ...
  }, [isLoadingGenreDiscover, genreDiscoverHasMore, selectedGenres.length, loadNextGenreDiscover]);
